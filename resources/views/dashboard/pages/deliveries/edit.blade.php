        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-12 d-flex justify-content-between">
                    <h1 class="m-0 text-dark">تعديل مندوب</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <!-- form start -->
                <form role="form" action="{{ route('update_information.deliveries', $delivery->id) }}" method="post">
                    @csrf
                    @method('post')
                    <div class="card-body">
                        <div class="form-group">
                            <label for="name">ألاسم</label>
                            <input type="text" name="name" value="{{ $delivery->name }}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ $delivery->username }}" type="text" name="username" class="form-control"
            ...
            <div class="card card-primary">
                <!-- form start -->
                <form role="form" action="{{ route('update_password.deliveries', $delivery->id) }}" method="post">
                    @csrf
                    @method('post')
                    <div class="card-body">
                        <div class="form-group">
